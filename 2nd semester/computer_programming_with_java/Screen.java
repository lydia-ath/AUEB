public class Screen extends Peripherals{
	...
	public String /*Port*/ getPort(){
		if (port.equalsIgnoreCase("HDMI") || port.equalsIgnoreCase("DisplayPort") || port.equalsIgnoreCase("DVI") || port.equalsIgnoreCase("HDMI DisplayPort") || port.equalsIgnoreCase("HDMI DVI") || port.equalsIgnoreCase("DisplayPort DVI"))
			return port;
		else 
			return "NONE";
	}
